...
For a redacted generated-app launch packet covering Lovable/v0/Bolt-style migrations, RLS evidence, RPC/function `EXECUTE`, storage policies, wrong-tenant tests, and backend ownership:
